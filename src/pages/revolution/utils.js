export const VisionParagrahphs = [
  ...
  "What once was confined to huge rooms and teams of engineers, now resides in every single one of our hands. Harnessing this unlimited potential by using it to solve problems and better lives is at the heart of what we do.",
...
export const TechnologyParagraphs = [
  "In 2013, Facebook invented a new way of building websites. This new system, React.js, completely revolutionizes the process and practice of software development.",
...
export const ConsulationParagraphs = [
...
export const ReviewParagraphs_ = [
...
export const MaintainParagraphs = [
...
export const IterateParagraphs = [
